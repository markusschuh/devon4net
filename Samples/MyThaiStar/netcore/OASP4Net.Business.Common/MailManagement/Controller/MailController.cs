...
namespace OASP4Net.Business.Common.MailManagement.Controller
{
    ...
    /// 
    /// </summary>
    public class MailApiController : OASP4NetController
    {
        ...
        /// </summary>
        public MailApiController(IBookingService bookingService, IMapper mapper, ILogger<BookingController> logger) :base(logger,mapper)
        {
