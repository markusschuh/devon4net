    ...
    public class AopControllerAttribute : ActionFilterAttribute
    {
        ...
        {                
            try
            {
                ...
                OASP4Net.Infrastructure.Log.OASP4NetLogger.Information($"Action: OnActionExecuting | Controller: {controllerValues.ControllerName} | method: {controllerValues.ControllerMethod}| ActionArguments: {controllerValues.ActionArguments}");
                base.OnActionExecuting(context);
            }
            catch (Exception ex)
            {
                OASP4Net.Infrastructure.Log.OASP4NetLogger.Error(ex);
                throw ex;
            }
        }
        ...
        public override Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            {
                var controllerValues = GetControllerProperties((Microsoft.AspNetCore.Mvc.Controllers.ControllerActionDescriptor)context.ActionDescriptor, context.ActionArguments);
                OASP4Net.Infrastructure.Log.OASP4NetLogger.Information($"Action: OnActionExecutionAsync | Controller: {controllerValues.ControllerName} | method: {controllerValues.ControllerMethod}| ActionArguments: {controllerValues.ActionArguments}");
        ...
        {
            OASP4Net.Infrastructure.Log.OASP4NetLogger.Debug($"Result: {result.StatusCode} | Value: {result.Value}");
        }
